...
const Footer = () => {
  return (
    <footer className='left-0 bottom-0 w-full fixed flex justify-between mx-auto px-6 pb-6 mt-6 border-gray-300 border-t border-b'>
        ...
        <div className='flex items-center gap-6 mt-6 max-md:justify-center'>
            <a href="mailto:ebikemeese@gmail.com?subject=DjangoBnb" target='_blank'>
